...
interface FinancialBalanceContentProps {
  balanceSheet: IFinancialItem[];
  currency: string;
}
...
const FinancialBalanceContent: React.FC<FinancialBalanceContentProps> = ({
  balanceSheet,
  currency,
}) => {
...
export default FinancialBalanceContent;
